...
export const SignUp = () => {
    ...
    const onSuccess = async (credentialResponse) => {
        ...
        try {
            ...
            const response =await axios.post("https://ideal-dollop-7gvvxxv5gjwhw6g5-3000.app.github.dev/login_google",
            { tokenId: credential }, { withCredentials: true });

            //redirigimos al usuario a la parina de private
            if (response.status === 200) {
                console.log("Respuesta del backend:", response.data);
                window.location.href = "https://ideal-dollop-7gvvxxv5gjwhw6g5-3000.app.github.dev/private";
            } else {
        ...
        <div className="text-center mt-5 d-flex justify-content-center signup"  >
            ...
            <div className="divForm w-25 ">
                ...
                <form className="formSign d-flex justify-content-center border border-3 border-dark row">
                    ...
                    <div className="mb-4">
                        <p id="Help"> o puedes registrate con</p>
                        <GoogleLogin
                            clientId ={clientId}
                            onSuccess={onSuccess}
                            onError={onFailure}
